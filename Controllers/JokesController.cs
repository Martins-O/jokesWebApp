...
namespace JokeWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,JokesQuestion,JokeAnswer")] Jokes jokes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokesQuestion,JokeAnswer")] Jokes jokes)
        {
            if (id != jokes.Id)
            {
                return NotFound();
